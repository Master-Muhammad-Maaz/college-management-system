          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">
                {selectedCourse} | {isHolidayMode ? "Official Holiday Mode" : "System Control Center"}
              </p>
            </div>
          </div>
        ...
        <div className="flex gap-2 mb-8 overflow-x-auto no-scrollbar pb-2">
          {courses.map(c => (
            <button 
              ...
              className={`px-6 py-2 rounded-full text-[9px] font-black uppercase border transition-all flex-shrink-0 ${selectedCourse === c ? "bg-blue-600 text-white border-blue-600 shadow-md" : "bg-white text-slate-400 border-slate-100 hover:border-blue-200"}`}
            >
              {c}
            </button>
          ))}
